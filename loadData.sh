...
if [ ! -f /app/models/Stable-diffusion/LoDi_Sports_v1_sd15_noema_fp16.safetensors ]; then
  wget --header="Authorization: Bearer $HUGGINGFACE_TOKEN" https://huggingface.co/Artifice-ArtHouse/LoDi_Sports/resolve/main/LoDi_Sports_v1_sd15_noema_fp16.safetensors -N -O /app/models/Stable-diffusion/LoDi_Sports_v1_sd15_noema_fp16.safetensors --content-disposition
fi
...
if [ ! -f /app/models/Stable-diffusion/3dmodel2_6624.safetensors ]; then
  wget --header="Authorization: Bearer $HUGGINGFACE_TOKEN" https://huggingface.co/Artifice-ArtHouse/3dlook.v1.0/resolve/main/3dmodel2_6624.safetensors -N -O /app/models/Stable-diffusion/3dmodel2_6624.safetensors --content-disposition
fi

if [ ! -f /app/models/Stable-diffusion/3dmodel2_6624.yaml ]; then
  wget --header="Authorization: Bearer $HUGGINGFACE_TOKEN" https://huggingface.co/Artifice-ArtHouse/3dlook.v1.0/resolve/main/3dmodel2_6624.yaml -N -O /app/models/Stable-diffusion/3dmodel2_6624.yaml --content-disposition
fi